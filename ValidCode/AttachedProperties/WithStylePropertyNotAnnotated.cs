...
public static class WithStylePropertyNotAnnotated
{
    ...
    public static void SetStyle(TextBlock element, Style value) => element.SetValue(StyleProperty, value);
    ...
    public static Style GetStyle(TextBlock element) => (Style)element.GetValue(StyleProperty);
}
