...
namespace RoslynSandbox
{
    ...
    public class FooControl : Control
    {
        ...
        public int Bar
        {
            ...
            AnalyzerAssert.Diagnostics(Analyzer, ExpectedDiagnostic.WithMessage("Field 'Error' that is backing field for the DependencyProperty registered as 'Bar' should be named 'BarProperty'."), testCode);
        }
