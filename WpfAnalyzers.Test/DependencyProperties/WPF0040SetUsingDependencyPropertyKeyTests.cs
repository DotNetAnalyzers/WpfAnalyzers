namespace WpfAnalyzers.Test.DependencyProperties
{
    ...
    public class WPF0040SetUsingDependencyPropertyKeyTests : CodeFixVerifier
    {
        [TestCase("SetValue")]
...
public class FooControl : Control
{
    ...
    public int Bar
    {
        ...
        [TestCase("SetValue")]
        [TestCase("SetCurrentValue")]
        public async Task SetValueErrorAttachedReadOnly(string method)
        {
            var testCode = @"
using System.Windows;
...
public static class Foo
{
    ...
    public static int GetBar(DependencyObject element)
    {
        ...
        {
            yield return new WPF0040SetUsingDependencyPropertyKey();
        }

        protected override CodeFixProvider GetCSharpCodeFixProvider()
        {
            return new UseDependencyPropertyKeyCodeFixProvider();
        }
    }
}