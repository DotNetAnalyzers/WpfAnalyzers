namespace WpfAnalyzers.Test.DependencyProperties
{
    ...
    public class WA1230ClrAccessorsForAttachedPropertyMustMatchRegisteredNameTests : CodeFixVerifier
    {
        [Test]
...
public static class Foo
{
    ...
    public static int GetBar(this FrameworkElement element) => (int)element.GetValue(BarProperty);
        ...
        {
            yield return new WA1230ClrAccessorsForAttachedPropertyMustMatchRegisteredName();
        }
