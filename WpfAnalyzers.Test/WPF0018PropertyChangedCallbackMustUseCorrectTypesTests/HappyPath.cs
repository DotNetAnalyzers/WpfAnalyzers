namespace WpfAnalyzers.Test.WPF0018PropertyChangedCallbackMustUseCorrectTypesTests
{
    ...
    {
        private static readonly WPF0018PropertyChangedCallbackMustUseCorrectTypes Analyzer = new WPF0018PropertyChangedCallbackMustUseCorrectTypes();
...
namespace RoslynSandbox
{
    ...
    public class FooControl : UserControl
    {
        static FooControl()
        {
            BackgroundProperty.OverrideMetadata(typeof(FooControl), new FrameworkPropertyMetadata(null, OnBackgroundChanged));
        }
